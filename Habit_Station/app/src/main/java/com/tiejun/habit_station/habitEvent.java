...
public class habitEvent {
    ...
    public Date geteTime(){ return this.eTime; }

    public String geteReason(){ return this.eReason; }

    public String geteComment(){ return this.eComment; }

    public Image getePhoto(){ return this.ePhoto; }
    ...
    public void seteName(String name){ this.eName = name; }

    public void seteTime(Date time){
        this.eTime = time;
    }

    public void seteReason(String reason){ this.eReason = reason; }

    public void setePhoto(Image photo){ this.ePhoto = photo; }

    public void seteLocation(Location location){ this.eLocation = location; }

    public void setStatus(boolean status){ this.status = status; }

    public void seteComment(String comment) throws ArgTooLongException{
